...
function initAdmin() {
  ...
  function renderItems(items) {
    var parsedItems = Object.values(items); // "items": {
    //     "5eee6692a27a66807cf2bea4": {....}, <= values(item)
    //     "5eee66a5a27a66807cf2bea5": {
    //            "item": {
    ...
    //     }
    // },
    // Array of values(item) of items object = [{item:{}}, {item:{}},...etc]
...
function updateCart(data) {
  axios__WEBPACK_IMPORTED_MODULE_0__["default"].post('/update-cart', data).then(function (res) {
...
function deleteCart(data) {
  console.log(data);
  axios__WEBPACK_IMPORTED_MODULE_0__["default"]["delete"]('/delete-cart', {
    data: data
...
function notification() {
  ...
  return new (noty__WEBPACK_IMPORTED_MODULE_1___default())({
    type: 'success',
    timeout: 2000,
